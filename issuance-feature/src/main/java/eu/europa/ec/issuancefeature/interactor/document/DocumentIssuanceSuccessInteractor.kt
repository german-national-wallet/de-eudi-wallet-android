...
class DocumentIssuanceSuccessInteractorImpl(
    ...
    override fun getUiItems(documentIds: List<DocumentId>): Flow<DocumentIssuanceSuccessInteractorGetUiItemsPartialState> {
        return flow {
            ...
            var eaaCardData: EaaCardData? = null
            ...
            documentIds.forEach { documentId ->
                try {
                    ...
                    if (eaaCardData == null) {
                        eaaCardData = document.toEaaCardData(resourceProvider.getLocale())
                    }
            ...
            emit(
                DocumentIssuanceSuccessInteractorGetUiItemsPartialState.Success(
                    ...
                    stickyButtonText = resourceProvider.getString(R.string.document_success_issuance_sticky_button_text),
