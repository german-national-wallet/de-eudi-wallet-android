...
/** Value 12 */
const val SPACING_EXTRA_MEDIUM = 12
...
/** Value 32 */
const val SPACING_LARGE_32 = 32

/** Value 48 */
const val SPACING_EXTRA_LARGE = 48

/** Value 62 */
const val SPACING_LARGE_72 = 72
...
/** Size 18 */
const val SIZE_MEDIUM_LARGE = 18
 ...
 * Value 1.0f
 */
const val WEIGHT_1 = 1.0f

/**
 * Value 1
 */
const val BORDER_STROKE_1 = 1


const val PID_DOCUMENT_TOP_BAR_HEIGHT = 180

const val BUTTON_HEIGHT = 48

const val NAVIGATION_ICON_BOX_SIZE = 40

const val SPACER_SIZE_1 = 1

const val ELEVATION_8 = 8

const val EID_LOGO_SIZE = 72
