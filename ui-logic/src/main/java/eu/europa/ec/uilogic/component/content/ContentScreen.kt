...
fun ContentScreen(
    ...
    genericErrorDialogConfig: GenericErrorDialogConfig? = null,
    ...
    Scaffold(
        ...
        Box(
            ...
            when {
                ...
                isLoading -> {
                    LoadingIndicator(subText = loadingSubText)
                }
            ...
            genericErrorDialogConfig?.let { config ->
