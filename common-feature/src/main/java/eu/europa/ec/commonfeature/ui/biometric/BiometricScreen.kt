        ...
        is BiometricMode.Default -> {
            ...
            Column(
                ...
                PinFieldLayout(
                    modifier = Modifier.fillMaxWidth(),
                    state = state,
                    onPinInput = { onEventSent(Event.OnQuickPinEntered) }
                )
            }
        }
...
private fun PinFieldLayout(
    ...
    CodeEntryField(
        ...
        onCodeChange = onPinInput,
        config = CodeEntryConfig(
            // Do not steal focus when biometrics are offered first; the PIN is the fallback.
            ...
            state = State(
                config = BiometricUiConfig(
                    mode = BiometricMode.Default(
                        ...
                        textAbovePin = stringResource(R.string.loading_header_description),
                    ),
